...
namespace RayXu.LeetCode.CmdApp
{
    partial class LeetCode
    {
        ...
        public string IntToRoman(int num)
        {
            ...
            for (int i = RomanDic.Count - 1; i >= 0; i--)
            {
                while (num / RomanDic[i].Item1 > 0)
                {
                    num -= RomanDic[i].Item1;
                    result.Append(RomanDic[i].Item2);
                }
            }
        ...
        private static List<Tuple<int, string>> RomanDic = new List<Tuple<int, string>>
        {
